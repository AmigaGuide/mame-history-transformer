...
def cmd_root(args: argparse.Namespace) -> int:
    ...
    _print_active_banner()
    print(args._root_parser.format_help())
    return 0
...
def main() -> None:
    ...
    s_fetch_check.add_argument("--debug", action="store_true", help="Verbose HTTP probe logging")
